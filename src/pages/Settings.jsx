            ...
            <div style={mainStyle}>
                ...
                <main style={contentStyle}>
                    ...
                    {currentRole && (
                        ...
                        <section style={accountSectionStyle}>

                            <div style={accountHeaderStyle}>

                                <div>

                                    <div style={accountEyebrowStyle}>
                                        ACCOUNT ACCESS
                                    </div>

                                    <h2 style={accountTitleStyle}>
                                        Your Access Level
                                    </h2>
    ...
    return (
        ...
        >
            ...
            <div style={settingContentStyle}>
                ...
                <div style={settingTitleRowStyle}>

                    <h3 style={settingTitleStyle}>
                        {item.title}
                    </h3>
